...
const NAV_SECTIONS = [
  ...
  { label: "Operations", ids: ["Maintenance","Schedules","Fuel","FuelRecon","Incidents","Hire","PreOp"] },
  { label: "People", ids: ["Employees", "Timesheets", "Leave", "Projects"] },
  { label: "Finance", ids: ["Budgets", "Compliance", "Reports", "SARSReport", "ProjectCost"] },
  { label: "Intelligence", ids: ["Analytics", "FuelRecon", "Utilisation", "Alerts", "AssetExpenses"] },
